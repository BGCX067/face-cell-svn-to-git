...
package asSkinStyle
{
	...
	public class ReflPositionInfo
	{
		 ...
		 * 
		 */
		public static function encodeChildToXml(dspc:DisplayObjectContainer
		 ...
		 * @return 
		 */
		private static function isCanCode(dsp:DisplayObject,attrName:String):Boolean
		{
		 ...
		 * @return 
		 */
		public static function encodeChildToJson(dspc:DisplayObjectContainer
												,ignoreNameLs:Vector.<String>=null):String
		{
			...
			var refAttrLs:Vector.<String> = REF_ATTR_LS;
			var intAttrLs:Vector.<String> = INIT_ATTR_LS;
		 ...
		 * @return 
		 */
		public static function encodeChildToObj(dspc:DisplayObjectContainer
